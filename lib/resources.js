...
module.exports.Messages = {
    ...
    Help:{
      DefaultCommandWarning: colors.fg.getRgb(5,1,0) + 'No command specified, displaying the help page. You can access this content by using the following command: ' + colors.reset + ' fnhub help\n',
      HelpIntro: "This is the help page for fnhub. The fnhub CLI supports the following commands:\n",
      Init: colors.fg.getRgb(0,5,0) + "fnhub init: This initializes a fnhub module.\n" + colors.reset + "\nArguments: \n"
      ...
      Add: colors.fg.getRgb(0,5,0) + "fnhub add: Adds a function to the current module.\n" + colors.reset + "\nArguments: \n"
      ...
      Delete: colors.fg.getRgb(0,5,0) + "fnhub delete: Deletes a module.\n" + colors.reset + "\nArguments: \n"
            + "\t --description - string - the module to delete (optional, default: pulled from module.yml)\n",
      Info: colors.fg.getRgb(0,5,0) + "fnhub info: Provides information on a specific module.\n" + colors.reset + "\nArguments: \n"
            + "\t --name - string - the module's name (required, default: none)\n"
            + "\t --version - string - the module version (optional, default: latest)\n",
      Who: colors.fg.getRgb(0,5,0) + "fnhub who: Provides details on the currently authenticated user.\n" + colors.reset + "\nno arguments\n",
      Publish: colors.fg.getRgb(0,5,0) + "fnhub publish: Publishes the module to fnhub.io.\n" + colors.reset + "\nno arguments\n",
      Signin: colors.fg.getRgb(0,5,0) + "fnhub signin: Authenticates the user with fnhub.io.\n" + colors.reset + "\nArguments: \n"
      ...
      Signout: colors.fg.getRgb(0,5,0) + "fnhub signout: Ends the current user's session.\n" + colors.reset + "\nno arguments\n",
      Signup: colors.fg.getRgb(0,5,0) + "fnhub signup: Creates an account on fnhub.io.\n" + colors.reset + "\nArguments: \n"
      ...
      Version: colors.fg.getRgb(0,5,0) + "fnhub version: Retrieves the module's version from module.yaml.\n" + colors.reset + "\nno arguments\n",
      VersionMajor: colors.fg.getRgb(0,5,0) + "fnhub version major: Increments the module's major version in module.yaml.\n" + colors.reset + "\nno arguments\n",
      VersionMinor: colors.fg.getRgb(0,5,0) + "fnhub version minor: Increments the module's minor version in module.yaml.\n" + colors.reset + "\nno arguments\n",
      VersionPatch: colors.fg.getRgb(0,5,0) + "fnhub version patch: Increments the module's patch version in module.yaml.\n" + colors.reset + "\nno arguments\n",
      CfCreate: colors.fg.getRgb(0,5,0) + "fnhub cf create: Creates a new AWS CloudFormation stack file in fnhub-stack.yaml.\n" + colors.reset + "\nArguments: \n"
            + "\t --name - string - the stack name (required, default: none)\n"
            + "\t --description - string - the stack's description (required, default: none)\n",
      CfInclude: colors.fg.getRgb(0,5,0) + "fnhub cf include: Adds a module in the fnhub-stack.yaml stack definition file in the local directory.\n" + colors.reset + "\nArguments: \n"
      ...
      CfDeploy: colors.fg.getRgb(0,5,0) + "fnhub cf deploy: Uses the AWS CLI to deploy your stack to AWS Cloud Formation.\n" + colors.reset + "\nno arguments\n",
      SamCreate: colors.fg.getRgb(0,5,0) + "fnhub sam create: Creates a new AWS SAM stack file in fnhub-stack.yaml.\n" + colors.reset + "\nArguments: \n"
            + "\t --name - string - the stack name (required, default: none)\n"
            + "\t --description - string - the stack's description (required, default: none)\n",
      SamInclude: colors.fg.getRgb(0,5,0) + "fnhub sam include: Adds a module in the fnhub-stack.yaml stack definition file in the local directory.\n" + colors.reset + "\nArguments: \n"
            + "\t --module - string - the name of the module to include (required, default: none)\n"
            + "\t --version - string - the module version to include (required, default: latest)\n",
      SamDeploy: colors.fg.getRgb(0,5,0) + "fnhub sam deploy: Uses the AWS CLI to deploy your stack to AWS SAM.\n" + colors.reset + "\nno arguments\n"
    }
}
