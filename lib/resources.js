...
module.exports.Questions = {
  ...
  Add:{
    ...
    EnvNameFirst: buildQuestion('Add first Environment Variable name', false),
    EnvValue: buildQuestion('Environment Variable value', false),
    EnvNameAnother: buildQuestion('Add another Environment Variable name', false),
  },
  Delete:{
